...
ml /I%MASMINCPATH% /c  /coff  /Cp brady2small.asm

if %errorlevel% neq 0 goto :error

ml /I%MASMINCPATH% /c  /coff  /Cp football.asm

if %errorlevel% neq 0 goto :error

ml /I%MASMINCPATH% /c  /coff  /Cp josephrussell.asm

if %errorlevel% neq 0 goto :error

ml /I%MASMINCPATH% /c  /coff  /Cp russgameface.asm

if %errorlevel% neq 0 goto :error

ml /I%MASMINCPATH% /c  /coff  /Cp lynch2small.asm

if %errorlevel% neq 0 goto :error

link /SUBSYSTEM:WINDOWS  /LIBPATH:%MASMLIBPATH% game.obj blit.obj trig.obj lines.obj stars.obj brady2small.obj lynch2small.obj football.obj josephrussell.obj russgameface.obj libgame.obj
